...
CXXFLAGS="-O0 -g -march=x86-64-v2 -mtune=intel -c -Dlinux -D__x86_64__ -std=c++17 -fPIC -Wall -Wextra -Wno-unused-variable -Wno-unused-value -Wno-unused-function -Wno-unused-parameter -Wno-unused-but-set-variable -Wno-unused-local-typedefs"
